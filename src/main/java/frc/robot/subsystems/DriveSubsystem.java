...
public class DriveSubsystem extends SubsystemBase {
  ...
  public void manualDrive(double move, double turn, double scale){
    drive.arcadeDrive(-move * Math.abs(move) * scale, turn * Math.abs(turn) * 0.86); //Riley came up with the absolute value idea--> very smart
  }
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("Angle constant", 0.025);
    SmartDashboard.putNumber("Distance constant", 0.15);
    SmartDashboard.putNumber("Max turn", 0.25);
    SmartDashboard.putNumber("Max move", 0.5);
    SmartDashboard.putNumber("Position 1", 0.0);
